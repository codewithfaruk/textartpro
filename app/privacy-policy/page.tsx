...
export function metadata() {
  return {
    title: "Privacy Policy for Text Art",
    description: ` one of our main priorities is the privacy of our visitors. This Privacy
      Policy document contains types of information that is collected and
      recorded by www.textartpro.com and how we use it.`,
  };
}

export default function Page() {
  return (
    <main className="prose mx-6 md:max-w-7xl md:mx-auto">
      <h1>Privacy Policy for Text Art</h1>
      <p>
        At <a href="https://www.textartpro.com/">www.textartpro.com</a>,
        accessible from{" "}
        <a href="https://www.textartpro.com/">https://www.textartpro.com/</a>,
      ...
      <p>
        ...
        shared and/or collect in www.textartpro.com. This policy is not
      ...
      <h2>Log Files</h2>
      <p>
        www.textartpro.com follows a standard procedure of using log files.
      ...
      <p>
        ...
        advertising partners of www.textartpro.com.
      </p>
      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on www.textartpro.com, which are
      ...
      <p>
        Note that www.textartpro.com has no access to or control over these
        cookies that are used by third-party advertisers.
      </p>

      <h2>Third Party Privacy Policies</h2>
      <p>
        www.textartpro.com's Privacy Policy does not apply to other advertisers
      ...
      <p>
        www.textartpro.com does not knowingly collect any Personal Identifiable
