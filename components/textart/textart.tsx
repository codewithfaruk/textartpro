...
export default function TextArt({ params }: { params: paramsType }) {
  ...
  return (
    <main className="bg-[#eef2ff]">
      <section className="mx-5 bg-[#eef2ff] lg:max-w-7xl md:mx-auto">
        <Categories
        ...
        <div className="flex flex-col justify-center gap-6 md:flex-row md:flex-wrap overflow-hidden hide-scroll pb-6">
          {selectedObject.data.map((item, index) => (
            <div
            ...
            >
              <Dialog.Root key={item}>
                <Dialog.Trigger className="flex flex-col items-center justify-center h-full w-full md:px-12">
                ...
                <Dialog.Portal>
                  ...
                  <Dialog.Content className="fixed w-[90%]  top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50">
                    <CopyModal item={item} url={params.textart} />
                  </Dialog.Content>
                </Dialog.Portal>
              </Dialog.Root>
                ...
                <Dialog.Root key={item}>
                  ...
                  <Dialog.Portal>
                    ...
                    <Dialog.Content className="fixed w-[90%] bg-neutral-50 p-8 rounded-xl top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 md:max-w-xl md:mx-auto">
                      <ShareModal item={item} url={params.textart} />
                    </Dialog.Content>
                  </Dialog.Portal>
                </Dialog.Root>
              </div>
        ...
        <main className="prose bg-neutral-50 px-3 py-4 rounded-xl my-3 md:max-w-7xl md:mx-auto">
          ...
          <p>
            ...
            Information Interchange) to create simple to complex text art
            images. Because it uses the ASCII format, these text art symbols can
            be inserted almost anywhere. This is why ASCII art generators have
            become such a popular digital art format and are used in various
            areas like social media posts, forum signatures, video games,
            graphic design posts, etc. Text art copy paste characters are used
            by almost everyone who is familiar with the internet. Hence, we can
            say that text to art has a huge significance in our day-to-day life.
          </p>
          <Image
            alt="textartpro.com"
            title="textartpro.com"
            src="/textartpro.jpg"
            width={400}
            height={200}
          ...
          <p>
            ...
            emojis, personalized cards, and other complex creative purposes.
            ASCII art for Instagram comments and text art for Instagram bios
            have become extremely popular among the younger generation.
          </p>
          {<Ads/>}
          <p>
            ...
            industry. You can go to any text art website and choose ASCII art
            from there. Then you can simply copy and paste it to any location.
          </p>
          <h2>Creating ASCII Art - Pro Text Art in The Modern World</h2>
          <p>
            Just like in traditional art, basic characters like lines and dots
            are used in ASCII text art to create simple elements. ASCII art
            small characters can make modern emojis, stickers, and even fancy
            digital letter art.
          </p>
          <p>
            ...
            means you can discover and use instant text art using a text art
            copy and paste website. If you are interested in this, you have come
            to the right place!
          </p>
          <p>
            On websites like ours, you can type in ASCII art name and discover
            ready-made text art. For this, go to the top of the homepage. You
            will find several different categories with hundreds of ASCII text
            art graphics under each category. Click on the category of your
            choice and pick the perfect, unique Text art cat, Text art gun, etc.
            graphics and use it wherever you want to!
          </p>
          ...
          <p>
            Text art copy paste has many functions. These functions are what
            have made ASCII so popular and widely used by modern users. Even
            today the same principles that are used in ASCII text formation are
            used by other, more complex programming formats. What are the major
            functions of text art ASCII generators?
          </p>
          <ul>
            <li>
            ...
            <li>
              ...
              ASCII art for Instagram bio which helps them gain more followers
              and increase their engagement. You can also develop your gaming
            ...
            <li>
              ...
              and celebrations, valentine's day posts and celebrations etc.
              'Text art heart', 'ASCII art love' etc. are some of the most
              commonly searched phrases by users looking for expressive, instant
              ASCII text art. For example, you can use love text art for a
              Valentine's Day message, and birthday text art for a birthday
              celebration message!
            </li>
            <li>
              ...
              comments to increase social media engagement on Instagram,
              Facebook, Twitter, etc. Text art comments are very popular these
              days and you can use our text art copy paste feature to get free
              access to text to art graphics. The correct text art comment can
              make you popular among both friends and strangers, and even
              impress your role models! You can use text art ASCII comment to
              launch a successful business on Facebook, Instagram, and WhatsApp.
            </li>
          </ul>
          {<Ads/>}
          <h2>Conclusion</h2>
          <p>
            ...
            digital projects. It is a graphics tool that has a rich and
            versatile history. It is one of the classics that will never become
                    ...
                    <button
                      ...
                      onClick={() => {
                        navigator.clipboard.writeText(
                          process.env.NEXT_PUBLIC_SITE + url
                        );
